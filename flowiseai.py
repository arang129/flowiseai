...
def setup_flowiseai():
    ...
    return {
        'command': [sys.executable, '-m', 'flowiseai', '-u', '{unix_socket}'],
        'unix_socket': True,
        'launcher_entry': {
            'enabled': True,
            'icon_path': '/opt/tljh/hub/share/jupyterhub/flowiseai.svg',
            'title': 'FlowiseAI',
        },
    }
...
<head>
    <title>Flowise</title>
    <link rel="icon" type="image/png" href="https://avatars.githubusercontent.com/u/128289781?s=48&v=4">
...
<body>
    <iframe src="https://flowiseai.yunlab.app/" 
